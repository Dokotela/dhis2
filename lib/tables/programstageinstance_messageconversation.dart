...
class ProgramstageinstanceMessageconversation
    with _$ProgramstageinstanceMessageconversation {
  ...
  factory ProgramstageinstanceMessageconversation.fromYaml(dynamic yaml) => yaml
          is String
  ...
  factory ProgramstageinstanceMessageconversation.fromJson(
  ...
  factory ProgramstageinstanceMessageconversation.fromJsonString(
      String source) {
