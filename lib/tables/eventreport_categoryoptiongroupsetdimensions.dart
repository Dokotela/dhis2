...
class EventreportCategoryoptiongroupsetdimensions
    with _$EventreportCategoryoptiongroupsetdimensions {
  ...
  factory EventreportCategoryoptiongroupsetdimensions.fromYaml(dynamic yaml) =>
      yaml is String
  ...
  factory EventreportCategoryoptiongroupsetdimensions.fromJson(
  ...
  factory EventreportCategoryoptiongroupsetdimensions.fromJsonString(
      String source) {
