...
class ValidationnotificationtemplateRecipientusergroups
    with _$ValidationnotificationtemplateRecipientusergroups {
  ...
  factory ValidationnotificationtemplateRecipientusergroups.fromYaml(
          dynamic yaml) =>
      yaml is String
  ...
  factory ValidationnotificationtemplateRecipientusergroups.fromJson(
  ...
  factory ValidationnotificationtemplateRecipientusergroups.fromJsonString(
      String source) {
