...
@freezed
class Validationnotificationtemplatevalidationrules with _$Validationnotificationtemplatevalidationrules {
...
required int validationnotificationtemplateid,
  ...
  factory Validationnotificationtemplatevalidationrules.fromYaml(dynamic yaml) => yaml is String
  ...
  factory Validationnotificationtemplatevalidationrules.fromJson(Map<String, dynamic> json) =>
  ...
  factory Validationnotificationtemplatevalidationrules.fromJsonString(String source) {
