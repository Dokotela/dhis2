...
@freezed
class CategoryoptiongroupsetdimensionItems with _$CategoryoptiongroupsetdimensionItems {
...
required int categoryoptiongroupid,
  ...
  factory CategoryoptiongroupsetdimensionItems.fromYaml(dynamic yaml) => yaml is String
  ...
  factory CategoryoptiongroupsetdimensionItems.fromJson(Map<String, dynamic> json) =>
