...
@freezed
class MapviewCategoryoptiongroupsetdimensions with _$MapviewCategoryoptiongroupsetdimensions {
...
required int mapviewid,
  ...
  factory MapviewCategoryoptiongroupsetdimensions.fromYaml(dynamic yaml) => yaml is String
  ...
  factory MapviewCategoryoptiongroupsetdimensions.fromJson(Map<String, dynamic> json) =>
  ...
  factory MapviewCategoryoptiongroupsetdimensions.fromJsonString(String source) {
