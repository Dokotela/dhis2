...
part 'eventvisualization_categorydimensions.freezed.dart';
...
required int categorydimensionid,
  ...
  factory EventvisualizationCategorydimensions.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ...
          : throw ArgumentError(
              'EventvisualizationCategorydimensions cannot be constructed from input provided,'
  ...
  factory EventvisualizationCategorydimensions.fromJsonString(String source) {
    final json = jsonDecode(source);
    if (json is Map<String, dynamic>) {
      return _$EventvisualizationCategorydimensionsFromJson(json);
    } else {
